        ...
        },
        {
            ...
            render: (_, record) => {
                return (
                    <div className="gap-1.5 flex">
                        {record.separation
                            ? moment(record.separation).format("LL")
                            : ""}
                    </div>
                );
            },
            ...
            render: (_, record) => {
                ...
                return (
                    ...
                    >
                        {record.estatus}{" "}
                        {record.quit_claim &&
                            record.quit_claim.status === "Approved" && (
                                <Tooltip title="Signed & Uploaded Quit Claim">
                                    <CheckSquareOutlined />
                                </Tooltip>
                            )}
                    </Tag>
