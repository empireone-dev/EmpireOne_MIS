...
export default function UpdateEmployeeFormSection() {
    ...
    useEffect(() => {
        setForm({
            ...
            position:
                applicant?.joboffer?.find((offer) => offer.status === "Hired")
                    ?.jobPos ||
                employee?.position ||
                "",
            dept:
            ...
            role_id:
                employee?.user_id?.role_id ||
                applicant?.employee?.user_id?.role_id ||
                "",
        });
    }, [applicant, employee]);
