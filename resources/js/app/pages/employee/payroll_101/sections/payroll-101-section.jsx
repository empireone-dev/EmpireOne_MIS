...
import {
    submit_payroll_101_acknowledge_service,
    get_payroll_101_acknowledge_service,
} from "@/app/pages/services/payroll-101-acknowledge-service";

export default function Payroll101Section() {
    ...
    // Stored e-signature from account profile (loaded with /api/user)
    ...
    useEffect(() => {
        ...
        get_payroll_101_acknowledge_service(emp_id)
            .then((res) => {
                if (res?.data) {
    ...
    const handleSubmit = async () => {
        ...
        // If no stored signature, require drawing one
        if (!signature) {
        ...
        setLoading(true);
        try {
            const res = await submit_payroll_101_acknowledge_service({
                emp_id,
                emp_name,
                signature,
            });
            ...
            <div className="w-full mb-10 px-4">
                <div className="bg-white rounded-lg shadow-md border border-gray-200 overflow-hidden">
                    ...
                    <div className="border-b border-gray-200">
                        <iframe
                            src="/documents/government-mandated.pdf"
                            title="Government Mandated Document"
                            className="w-full"
                            style={{ height: "1500px" }}
                        />
                    </div>
    ...
    return (
        <div className="w-full mb-10 px-4">
            ...
            <div className="border border-gray-300 rounded-lg overflow-hidden shadow-sm mb-6">
                <iframe
                    src="/documents/payroll_101_2026.pdf"
                    title="Payroll 101 Document"
                    className="w-full"
                    style={{ height: "1500px" }}
                />
            </div>
            ...
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-5">
                <label className="flex items-start gap-3 cursor-pointer">
                    ...
                    <span className="text-sm text-gray-700 leading-snug">
                        ...
                        of EmpireOne BPO Solutions Inc. I understand that any
