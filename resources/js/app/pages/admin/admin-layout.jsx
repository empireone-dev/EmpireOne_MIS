        ...
        },
        {
            ...
            children: [
                ...
                },
                {
                    ...
                    label: menuLabel(
                        "Job Title Section",
                        "/admin/sourcing/job_title_section",
                    ),
                    onClick: () =>
                      ...
                      children: [
                          {
                              ...
                              label: menuLabel(
                                  "Guide Questions",
                                  "/admin/recruitment/guide_question",
                              ),
                              onClick: () =>
                                  router.visit(
                                      "/admin/recruitment/guide_question",
                      ...
                      children: [
                          {
                              ...
                              onClick: () =>
                                  router.visit("/admin/hiring/pre_employment"),
                          },
                          {
                              key: "hiring_section",
                              icon: <HolderOutlined />,
                              label: menuLabel(
                                  "Hiring Section",
                                  "/admin/hiring/hiring_section",
                              ),
                              onClick: () =>
                                  router.visit("/admin/hiring/hiring_section"),
                          },
                      ],
                  },
                  {
                      ...
                      children: [
                          {
                              ...
                              label: menuLabel(
                                  "Documents",
                                  "/admin/onboarding/onboarding_docu",
                              ),
                              onClick: () =>
                                  router.visit(
                                      "/admin/onboarding/onboarding_docu",
                      ...
                      children: [
                          {
                              ...
                              label: menuLabel(
                                  "Attrition Section",
                                  "/admin/attrition/attrition_section",
                              ),
                              onClick: () =>
                                  router.visit(
                                      "/admin/attrition/attrition_section",
