...
export default function RateSupWorkerSection({ data }) {
            ...
            <table class="table table-bordered text-center w-full">
                ...
                <tbody>
                    <TableRowComponent
                        ...
                        value4="4"
                        value5="5"
                        selectedValue={String(data?.attrition?.ext_rate_int?.sup1 || exitInterviewForm?.sup1 || '')}
                    />
                    <TableRowComponent
                        onChange={handleRate}
                        ...
                        value4="4"
                        value5="5"
                        selectedValue={String(data?.attrition?.ext_rate_int?.sup2 || exitInterviewForm?.sup2 || '')}
                    />
                    <TableRowComponent
                        onChange={handleRate}
                        ...
                        value4="4"
                        value5="5"
                        selectedValue={String(data?.attrition?.ext_rate_int?.sup3 || exitInterviewForm?.sup3 || '')}
                    />
                    <TableRowComponent
                        onChange={handleRate}
                        ...
                        value4="4"
                        value5="5"
                        selectedValue={String(data?.attrition?.ext_rate_int?.sup4 || exitInterviewForm?.sup4 || '')}
                    />
                    <TableRowComponent
                        onChange={handleRate}
                        ...
                        value4="4"
                        value5="5"
                        selectedValue={String(data?.attrition?.ext_rate_int?.sup5 || exitInterviewForm?.sup5 || '')}
                    />
                    <TableRowComponent
                        onChange={handleRate}
                        ...
                        value4="4"
                        value5="5"
                        selectedValue={String(data?.attrition?.ext_rate_int?.sup6 || exitInterviewForm?.sup6 || '')}
                    />
                    <TableRowComponent
                        onChange={handleRate}
                        ...
                        value4="4"
                        value5="5"
                        selectedValue={String(data?.attrition?.ext_rate_int?.sup7 || exitInterviewForm?.sup7 || '')}
                    />
                </tbody>
            </table>
        </div>
