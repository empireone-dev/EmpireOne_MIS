...
<x-mail::message>
  ...
  Thank you for your interest in EmpireOne BPO Solutions Inc. We’d like to re-offer you the position of {{$data['jobPos']}}. Below is our New Job Offer: .
  ...
  To accept/decline this new job offer you may click on this link: https://empireone-hris.com/job_offer/{{$data['app_id']}}?id={{$data['id']}} EmpireOne BPO Solutions Inc - Job Offer
