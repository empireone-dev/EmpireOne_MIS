    ...
    return (
        <div className="bg-white shadow-2xl shadow-black rounded-lg p-6 mt-12 w-full">
            ...
            <div className="bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded mb-4">
                ...
                exit interview. The results are displayed below.
            </div>
            <div className="flex text-2xl items-center justify-center">
                <h1>
                    <b>EXIT INTERVIEW RESULT</b>
                </h1>
            </div>
            <div className="text-lg mb-2 mt-4">
                <h1>
                    INTERVIEWER:{" "}
                    <b>
                        {employee?.attrition?.ext_rate_int?.user
                            ?.employee_fname || ""}{" "}
                        {employee?.attrition?.ext_rate_int?.user
                            ?.employee_lname || ""}
                    </b>
                        ...
                        <div className="flex flex-col gap-4 mb-4 w-full">
                            ...
                            <div className=" w-full">
                                ...
                                <input
                                    type="text"
                                    value={`${
                                        employee?.user?.employee_fname || ""
                                    } ${employee?.user?.employee_mname || ""} ${
                                        employee?.user?.employee_lname || ""
                                    }`}
                                    className="border p-2 rounded w-full "
                                />
                            </div>
                        ...
                        <div className="flex flex-col gap-4 mb-4 w-full">
                            ...
                            <div className="flex flex-col w-full">
                                ...
                                <input
                                    type="text"
                                    value={`${
                                        employee?.dept?.user?.employee_fname ||
                                        ""
                                    } ${
                                        employee?.dept?.user?.employee_lname ||
                                        ""
                                    }`}
                                    className="border p-2 rounded w-full"
                                />
                    ...
                    <div className="flex w-full">
                        <div className="flex flex-col gap-4 mb-4 w-full">
                            <div className="flex flex-col w-full">
                                <label htmlFor="">
                                    <b>
                                        1. Main reason for leaving your current
                                        position.
                                    </b>
                                </label>
                                <textarea
                                    value={
                                        employee?.attrition?.ext_int?.mreas ||
                                        ""
                                    }
                                    type="text"
                                    name="mreas"
                    ...
                    <div className="flex w-full">
                        <div className="flex flex-col gap-4 mb-4 w-full">
                            <div className="flex flex-col w-full">
                                ...
                                <h1 htmlFor="">
                                    <b>
                                        2. Factors that influence decision to
                                        leave.
                                    </b>
                                </h1>
                                <div className="mt-2">
                                    {employee?.attrition?.ext_factor &&
                                    employee.attrition.ext_factor.length > 0 ? (
                                        <ul className="list-disc pl-5 space-y-1">
                                            {employee.attrition.ext_factor.map(
                                                (factorObj, index) => (
                                                    <li
                                                        key={index}
                    ...
                    <div className="flex w-full">
                        <div className="flex flex-col gap-4 mb-4 w-full">
                            <div className="flex flex-col w-full">
                                <label htmlFor="">
                                    <b>
                                        3. Wish/wishes he/she had known before
                                        taking the job
                                    </b>
                                </label>
                                <textarea
                                    value={
                                        employee?.attrition?.ext_int?.wish || ""
                                    }
                                    name="wish"
                                    type="text"
                                    placeholder=""
                    ...
                    <div className="flex w-full">
                        <div className="flex flex-col gap-4 mb-4 w-full">
                            <div className="flex flex-col w-full">
                                <label htmlFor="">
                                    <b>
                                        4.Suggestion to the management to make
                                        the organization a better place to work
                                    </b>
                                </label>
                                <textarea
                                    value={
                                        employee?.attrition?.ext_int?.suggest ||
                                        ""
                                    }
                                    name="suggest"
                                    type="text"
                    ...
                    <div className="flex w-full">
                        <div className="flex flex-col gap-4 mb-4 w-full">
                            <div className="flex flex-col w-full">
                                <label htmlFor="">
                                    <b>
                                        5. He/She appreciates the support that
                                        enables him/her to perform the job..
                                    </b>
                                </label>
                                <textarea
                                    value={
                                        employee?.attrition?.ext_int?.apprec ||
                                        ""
                                    }
                                    name="apprec"
                                    type="text"
