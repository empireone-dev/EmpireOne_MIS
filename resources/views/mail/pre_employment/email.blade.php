...
<x-mail::message>
    ...
    To facilitate the onboarding process, we kindly request you to submit the following pre-employment requirements through the provided link: https://empireone-hris.com/pre-employment/{{$data['app_id']}}/{{ urlencode($data['site']) }}?id={{$data['id']}}
