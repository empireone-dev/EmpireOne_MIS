import{r as o,R as d,c as H,j as a}from"./store-7169ceab.js";import{S as V}from"./index-bc6f990d.js";import{s as U}from"./account-service-a9b1e18d.js";import{u as $,a as B}from"./app-30616730.js";import"./extends-4c19d496.js";import"./objectWithoutProperties-82d8236c.js";import"./createSuper-cd69a035.js";import"./toPropertyKey-d8419463.js";import"./typeof-7fd5df1e.js";import"./index-9dff1dd2.js";/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const F=e=>{for(const t in e)if(t.startsWith("aria-")||t==="role"||t==="title")return!0;return!1},G=o.createContext({}),Z=()=>o.useContext(G),q=o.forwardRef(({color:e,size:t,strokeWidth:r,absoluteStrokeWidth:n,className:c="",children:i,iconNode:m,...l},u)=>{const{size:f=24,strokeWidth:g=2,absoluteStrokeWidth:h=!1,color:C="currentColor",className:S=""}=Z()??{},w=n??h?Number(r??g)*24/Number(t??f):r??g;return o.createElement("svg",{ref:u,...k,width:t??f??k.width,height:t??f??k.height,stroke:e??C,strokeWidth:w,className:L("lucide",S,c),...!i&&!F(l)&&{"aria-hidden":"true"},...l},[...m.map(([y,s])=>o.createElement(y,s)),...Array.isArray(i)?i:[i]])});/**
 * @license lucide-react v1.7.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
