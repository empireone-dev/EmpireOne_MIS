...
export default function UploadLastPaySection({uploadedFile, setUploadedFile,setFile}) {
    ...
    return (
        <div className='px-3 mb-2'>
            <h1 className="block uppercase tracking-wide  text-xs font-bold mb-3">Last Pay</h1>
