  ...
  <div class="container">
    <div class="content">
      ...
      <div class="header-info">
        ...
        <br>
        <p><strong>NAME:</strong> {{strtoupper($data['fname'])}} {{strtoupper($data['lname'])}}</p>
        <p><strong>HOME ADDRESS:</strong> {{$data['address'] ?? 'Philippines'}}</p>
      </div>
      ...
      <div class="section">
        <p><strong>Designation:</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{$data['jobPos']}}</p>
        <p><strong>Company:</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;EmpireOne BPO Solutions, Inc.</p>
        <p><strong>Place of Posting:</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Any EmpireOne office as business requires</p>
        <p><strong>Date of Joining:</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{ date('F j, Y', strtotime('+4 days')) }}</p>
        <p><strong>Compensation and Benefits:</strong>&nbsp;&nbsp;&nbsp;&nbsp;Annual Fixed Pay:</p>
        <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Night Shift Differential: 10%</p>
        <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Total Compensation (TC): PHP {{number_format($data['salary'])}}{{$data['allowance'] != 0 ? ' + PHP ' . number_format($data['allowance']) . ' ' . ($data['typea'] ?? '') : ''}}</p>
      </div>
