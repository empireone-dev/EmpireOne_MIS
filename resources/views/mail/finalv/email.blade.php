    ...
    <div class="container">
        <div class="content">
            ...
            <div style="text-align: center;">
                <a href="https://empireone-hris.com/accept_final/{{$data['app_id']}}/{{$data['ivdate']}}/{{$data['ivtime']}}/{{ urlencode(base64_encode($data['meet_link'])) }}?auto=true"
                    class="button"
                    style="display:inline-block; margin: 0 10px;">
                    Accept Invitation
                </a>

                <a href="https://empireone-hris.com/final/{{$data['app_id']}}/{{$data['ivdate']}}/{{$data['ivtime']}}/{{ urlencode(base64_encode($data['meet_link'])) }}"
                    class="button"
