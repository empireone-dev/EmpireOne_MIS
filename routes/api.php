...
Route::post('/sss_acknowledge', [SssAcknowledgeController::class, 'store']);
Route::get('/sss_acknowledge/{emp_id}', [SssAcknowledgeController::class, 'show']);
...
Route::resource('resource_hub', ResourceHubController::class)->only(['index', 'store', 'destroy']);
...
Route::put('/approve_quit_claim/{id}', [AttritionController::class, 'approve_quit_claim']);
Route::put('/decline_quit_claim/{id}', [AttritionController::class, 'decline_quit_claim']);
...
Route::get('get_acknowledgment_by_emp_id/{emp_id}', [CocdAcknowledgeController::class, 'get_acknowledgment_by_emp_id']);
