...
export default function SendUploadLastPaySection({
    uploadedFile,
    setUploadedFile,
    setFile,
}) {
                    ...
                    <div className="flex items-center justify-center">
                        <label>
                            <input
                                ...
                                required
                            />
                            <div className="flex w-28 h-9 px-2 flex-col bg-green-600 rounded-full shadow text-white text-xs font-semibold leading-4 items-center justify-center cursor-pointer focus:outline-none">
                                Choose File
                            </div>
                        </label>
                    </div>
                ...
                {uploadedFile && (
                    <div id="PDFDisplay" className="mt-4 mb-4">
                        <div className="flex flex-1 items-center justify-end w-full bg-neutral-800 rounded-t-md">
                            <div>
                                <button
                                    className=" rounded-t-md text-white py-1.5 px-3 items-center justify-end"
