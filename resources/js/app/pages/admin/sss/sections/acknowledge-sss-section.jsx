...
import { get_sss_acknowledge_service, submit_sss_acknowledge_service } from "@/app/pages/services/sss-acknowledge-service";

export default function AcknowledgeSSSSection() {
    ...
    useEffect(() => {
        ...
        get_sss_acknowledge_service(emp_id)
            .then((res) => {
                if (res?.data) {
    ...
    const handleSubmit = async () => {
        ...
        setLoading(true);
        try {
            const res = await submit_sss_acknowledge_service({
                emp_id,
                emp_name,
                signature,
            });
                        ...
                        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6">
                            <div className="flex-1">
                                <p className="text-sm text-gray-600">
                                    ...
                                    understood the SSS orientation video.
                                </p>
