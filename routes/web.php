...
Route::get('/test-s3', function () {
    try {
        ...
        \Illuminate\Support\Facades\Log::error('S3 test failed', [
            'error' => $e->getMessage(),
...
Route::middleware(['auth:sanctum', 'ensureAdminRole'])->prefix('admin')->group(function () {
    ...
    Route::prefix('sourcing')->group(function () {
        ...
        Route::get('/account', function () {
            return Inertia::render('admin/sourcing/account/page');
        });
    ...
    Route::prefix('employee_relation')->group(function () {
        Route::prefix('/employee_section')->group(function () {
            ...
            Route::get('/update_employee/{app_id}/{user_id}', function () {
    ...
    Route::get('/payroll_101', function () {
        return Inertia::render('admin/payroll_101/page');
    });
...
Route::middleware(['auth:sanctum', 'ensureEmployeeRole'])->prefix('employee')->group(function () {
    ...
    Route::get('/payroll_101', function () {
        return Inertia::render('employee/payroll_101/page');
    });
    Route::get('/resource-hub', function () {
