...
export async function get_employee_service() {
    const res = await axios.get(
        "/api/employee" + window.location.search ?? "?page=1",
    );
    return res.data;
}
...
export async function get_employee_with_acknowledgment_service() {
    const res = await axios.get(
        "/api/get_employee_with_acknowledgment" + window.location.search ??
            "?page=1",
    );
    return res.data;
}

export async function get_employee_with_policy_acknowledgment_service() {
    const res = await axios.get(
        "/api/get_employee_with_policy_acknowledgment" +
...
export async function get_all_employees_with_acknowledgment_service() {
    const res = await axios.get(
        "/api/get_employee_with_acknowledgment?per_page=10000",
    );
    return res.data;
}
...
export async function get_employee_policy_acknowledgment_by_emp_id_service(
    emp_id,
) {
    const res = await axios.get(
        "/api/get_employee_policy_acknowledgment/" + emp_id,
    );
    return res.data;
}
...
export function get_acknowledgment_by_emp_id_service() {
    try {
        const result = axios.get(
            "/api/get_acknowledgment_by_emp_id/" +
