...
Route::middleware('not.employee')->resource('resource_hub', ResourceHubController::class)->only(['store', 'destroy']);
Route::resource('resource_hub', ResourceHubController::class)->only(['index']);
