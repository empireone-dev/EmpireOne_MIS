import { CakeIcon, CalendarDaysIcon, ClipboardDocumentListIcon, DocumentDuplicateIcon, FilmIcon, SparklesIcon, SwatchIcon } from '@heroicons/react/24/outline';
                ...
                <div class="py-10">
                    <div class="mx-auto ">
                        ...
                        <div class="mt-12 grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
                            ...
                            <div class="relative group overflow-hidden p-8 rounded-xl bg-white border border-gray-200  ">
                                <div aria-hidden="true" class="inset-0 absolute aspect-video border rounded-full -translate-y-1/2 group-hover:-translate-y-1/4 duration-300 bg-gradient-to-b from-sky-500 to-white   blur-2xl opacity-25  "></div>
                                <div class="relative">
                                    <div class="border border-sky-500/10 flex relative *:relative *:size-6 *:m-auto size-12 rounded-lg  /15 before:rounded-[7px] before:absolute before:inset-0 before:border-t before:border-white before:from-sky-100  before:bg-gradient-to-b   before:shadow ">
