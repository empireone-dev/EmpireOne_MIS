    ...
    <div className="bg-white shadow-2xl border border-gray-300 rounded-xl p-6 h-screen w-full">
      <div className="flex justify-end w-full mb-2">
        <Tooltip title="Convert PDF format">
          <FilePdfOutlined className="text-4xl hover:text-gray-500 cursor-pointer" onClick={generatePDF} />
        </Tooltip>
      </div>
      ...
      <div ref={pdfRef}>
        ...
        <form className="h-full px-4">
          ...
          Your employment status with EmpireOne BPO Solutions Inc. will be Probationary for a period of 3 to 6 months from the start of your employment.<br /><br />
          2. <b>Compensation</b><br />
          You shall receive a monthly salary of <b>Php&nbsp;
            {jo?.allowance ? (
              <>
                {new Intl.NumberFormat('en-PH', { style: 'decimal', minimumFractionDigits: 2 }).format(jo?.salary)} + Php
          ...
          applicable to your employment.<br /><br />
          4. <b>Employment Review</b><br />
          ...
          performance set by the company.<br /><br />
        </form>
      </div>
    </div>
  );
