...
import { get_hmo_acknowledge_service, submit_hmo_acknowledge_service } from "@/app/pages/services/hmo-acknowledge-service";

export default function AcknowledgeHmoSection() {
    ...
    useEffect(() => {
        ...
        get_hmo_acknowledge_service(emp_id)
            .then((res) => {
                if (res?.data) {
    ...
    const handleSubmit = async () => {
        ...
        setLoading(true);
        try {
            const res = await submit_hmo_acknowledge_service({
                emp_id,
                emp_name,
                signature,
            });
                        ...
                        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6">
                            <div className="flex-1">
                                <p className="text-sm text-gray-600">
                                    I hereby confirm that I have watched and
                                    understood the HMO orientation video.
                                </p>
        ...
        <div>
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-5">
                <label className="flex items-start gap-3 cursor-pointer">
                    ...
                    <span className="text-sm text-gray-700 leading-snug">
                        ...
                        , hereby acknowledge that I have watched and understood
                        the HMO orientation video provided by EmpireOne BPO
                        Solutions Inc. I understand the benefits and coverage
                        details of the company&apos;s HMO plan.
                    </span>
                </label>
            </div>
            ...
            {storedSignature ? (
                ...
                <div className="bg-white border border-gray-300 rounded-lg p-4 shadow-sm mb-5">
                    ...
                    <p className="text-xs text-gray-400 mb-3">
                        You don&apos;t have a registered signature. Please sign
                        in the box below using your mouse, trackpad, or touch
