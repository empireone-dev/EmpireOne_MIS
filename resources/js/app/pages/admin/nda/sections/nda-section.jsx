...
import {
    submit_nda_acknowledge_service,
    get_nda_acknowledge_service,
} from "@/app/pages/services/nda-acknowledge-service";
...
export default function NdaSection() {
    ...
    useEffect(() => {
        ...
        get_nda_acknowledge_service(emp_id)
            .then((res) => {
                if (res?.data) {
    ...
    const handleSubmit = async () => {
        ...
        setLoading(true);
        try {
            const res = await submit_nda_acknowledge_service({
                emp_id,
                emp_name,
                signature,
            });
                ...
                <div className="bg-white rounded-lg shadow-md border border-gray-200 overflow-hidden">
                    ...
                    <div className="flex items-center justify-between px-6 py-4 border-b border-gray-200 bg-gray-50">
                        ...
                        <div className="text-right">
                            <h2 className="text-base font-bold text-gray-800">Non-Disclosure Agreement (NDA)</h2>
