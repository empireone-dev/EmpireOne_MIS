...
import {
    submit_government_mandated_acknowledge_service,
    get_government_mandated_acknowledge_service,
} from "@/app/pages/services/government-mandated-acknowledge-service";

export default function GovernmentMandatedSection() {
    ...
    useEffect(() => {
        ...
        get_government_mandated_acknowledge_service(emp_id)
            .then((res) => {
                if (res?.data) {
    ...
    const handleSubmit = async () => {
        ...
        setLoading(true);
        try {
            const res = await submit_government_mandated_acknowledge_service({
                emp_id,
                emp_name,
                signature,
            });
