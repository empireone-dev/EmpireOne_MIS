...
export default function Page({ status, canResetPassword }) {
  ...
  async function handleSendOtp(e) {
    ...
    setForgotError('');
    try {
      const res = await axios.post('/otp/send', { employee_id: forgotEmpId });
                  ...
                  <div className="px-8 pt-6 pb-8 md:px-10">
                    ...
                    <form className="space-y-4" action="#">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <a href="#" onClick={openForgot} className="text-sm font-medium text-blue-600 hover:underline">Forgot password?</a>
                      </div>
                      <button
                      onClick={submitLogin}
                        type="submit"
          ...
          <div className="relative w-full max-w-sm mx-4 bg-white rounded-2xl shadow-2xl p-8">
            ...
            {forgotStep === 2 && (
              <>
                ...
                <p className="text-sm font-semibold text-blue-600 mb-5">{forgotEmailHint}</p>
