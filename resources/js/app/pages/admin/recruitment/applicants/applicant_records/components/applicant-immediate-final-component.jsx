...
import { get_applicant_thunk, proceed_final_immediate_thunk, proceed_initial_immediate_thunk } from "../redux/applicant-thunk";

export default function ApplicantImmediateFinalComponent({ data, item, status }) {
    ...
    async function handleProceed() {
        setLoading(true);
        try {
            store.dispatch(proceed_final_immediate_thunk(data));
        ...
        <>
            ...
            >
                <div className="flex flex-col gap-4 mb-7">
                    <h1>Are you sure you want to proceed with the final interview immediately?</h1>
                    {data && (
