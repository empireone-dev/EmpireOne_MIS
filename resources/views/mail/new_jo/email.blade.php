...
<head>
  ...
  <title>Re Offer Job Order</title>
  <style>
    body {
...
<body>
  ...
  <div class="container">
    <div class="content">
      ...
      <p> Thank you for your interest in EmpireOne BPO Solutions Inc. We’d like to re-offer you the position of <b>{{$data['jobPos']}}</b>. Below is our New Job Offer: .
      </p>
