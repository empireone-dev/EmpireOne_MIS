...
<x-mail::message>
    ...
    To facilitate the onboarding process, we kindly request you to submit the following pre-employment requirements through the provided link: http://127.0.0.1:8000/pre-employment/{{$data['app_id']}}?id={{$data['id']}}
